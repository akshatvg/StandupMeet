        ...
        <Box display="flex" flex="1">
          <div className={classes.coverLeft}>
            ...
            <div className={classes.item}>
              <div className={classes.coverContent}>
                <Box textAlign="center" fontSize="h6.fontSize" className={classes.fontStyle}></Box>
                <Box textAlign="center" fontWeight="fontWeightRegular" fontSize="h4.fontSize" className={classes.midItem}>High Performance Video Chat</Box>
                ...
                <Box textAlign="center" fontWeight="fontWeightRegular" className={classes.fontStyle} fontSize="h7.fontSize">Powered by ACTA.AI</Box>
              </div>
            </div>
          </div>
          <div className={classes.coverRight}>
            <Switch>
              ...
              <Route exact path="/join/:name" component={IndexCard} />
